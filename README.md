...
In the folder `program` the user will find two files. This is in case the user does not want to use the Raspberries PI cluster. In case the user wants to use the cluster, he or she must use the python script by the name of `bicimad_cluster` inside this folder. If not, he must use the other file.
